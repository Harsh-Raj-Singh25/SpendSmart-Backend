...
public class User {
    ...
    // provider tracks how the user signed up — LOCAL = email/password, GOOGLE = OAuth2
    @Builder.Default
    ...
    // Role-based access control — USER gets personal finance access, ADMIN gets platform access
    @Builder.Default
