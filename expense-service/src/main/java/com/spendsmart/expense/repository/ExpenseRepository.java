...
public interface ExpenseRepository extends JpaRepository<Expense, Long> {
	...
	Optional<Expense> findByExpenseId(Long expenseId); // n older versions of Java, if a database didn't find a record,
														// it would return null.
	// If you tried to call .getAmount() on a null object, your application would
	// crash with the dreaded NullPointerException.
